class OrderForm
  ...
  def save
    ...
    Address.create(post_code: post_code, region_id: region_id, municipalities: municipalities, banchi: banchi, building_name: building_name, number: number, order_id: order.id)
  end
end